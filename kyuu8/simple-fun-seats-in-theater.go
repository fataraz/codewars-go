...
//of all the people who sit behind you and in your column or the columns to your left. To gain some courage, you decide
//to calculate the number of such people and see if you can possibly make it to the exit without disturbing too many people.
//
...
//For nCols = 16, nRows = 11, col = 5 and row = 3, the output should be 96.
//posisi duduk = kolom 5 dan di baris 3
//jumlah baris = 11
//jumlah kolom = 16
//
//nRows - row  = behindRow
//11 - 3 = 8
//nCols - col + 1 = behindCOl
//16 - 5 = 12

func seatsInTheater(nCols int, nRows int, col int, row int) int {
	behindRow := nRows - row
	behindCol := nCols - col + 1
	return behindRow * behindCol
}
